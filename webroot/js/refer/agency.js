...
$(document).ready(function () {
    ...
    function parseReferData(data) {
        ...
        $.each(refer_user_data, function (key, item) {
            ...
            var dataDom = '<li class="clearfix"> <span class="fl"><img onerror="this.onerror=null;this.src=\'http://static.tongshijia.com/avatar/s/default.jpg\'" src="' + user_info['image'] + '"></span> <div class="tuijian_title"> <div class="tuijian_title_style clearfix"> <em class="fl">'+user_info['nickname']+'</em> <b>推荐了' + item['user_count'] + '个新用户，新用户购买总金额：' + ((item['total_money']) || 0) + '元</b> </div> </div> </li>';
