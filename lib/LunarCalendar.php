...
class lunar{
  #农历每月的天数
    ...
    // 14位天干，15位地支
    // 1-13位，12个月的天数（出现闰月时的13个月）
    // 0 闰月位，为几时表示闰几月，为0时表示当年无闰月
  ##############################
  #农历天干
  ...
  var $mweek=array(0=>"null",1=>"星期一",2=>"星期二",3=>"星期三",4=>"星期四",5=>"星期五",6=>"星期六",7=>"星期日");
  ##############################
  #赋给初值
  #天干地支
    var $ten=0;
...
echo date("Y年m月d日")." ".$nowday["year"]."年".$nowday["month"].$nowday["day"]."日 ".$nowday["week"];//调用
