...
('product_id', 1, '产品id', 'string', 'ProductSpecial', 'zh_cn', '250', 26, 1, 1, '', NULL, NULL, NULL, 1, '', 0, '', '', 'equal', 'input', '', 0, '', '', '', '', '', NULL),
('speical_id', 1, '所属专场', 'string', 'ProductSpecial', 'zh_cn', '250', 23, 1, 1, NULL, NULL, NULL, NULL, 1, '3=>双十二专场\n4=>今日特价\n1=>活动专场\n2=>百度特惠专场', 0, NULL, NULL, 'equal', '', NULL, 1, NULL, '', NULL, NULL, '没找到想要的专场请联系开发', NULL),
('show_day', 1, '优惠日', ' date', 'ProductSpecial', 'zh_cn', NULL, 23, 1, 1, NULL, NULL, NULL, NULL, 1, NULL, 0, NULL, NULL, 'equal', 'input', '0000-00-00', 1, NULL, '', NULL, NULL, '今日特价适用（0000-00-00是默认值）', NULL),
...
('special_price', 1, '价格', 'integer', 'ProductSpecial', 'zh_cn', '11', 24, 1, 1, NULL, NULL, NULL, NULL, 1, '', 0, NULL, NULL, 'equal', 'input', '-1', 1, NULL, ' ', NULL, NULL, '单位为分！为-1则使用默认价格', NULL),
