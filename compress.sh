...
uglifyjs ./webroot/static/opt/js/lazyload.min.js ./webroot/static/weshares/js/user-share-info.js -o ./webroot/static/weshares/js/user-share-info.min.js
...
cat ./webroot/static/opt/css/opt.css ./webroot/static/opt/css/share.css | cleancss -o ./webroot/static/opt/css/new-opt.min.css
