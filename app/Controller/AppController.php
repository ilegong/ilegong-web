...
class AppController extends Controller {
 ...
 // 是否转码
    ...
    public $admins = array('753', '632', '658', '146', '8', '141', '818', '819', '755');
    ...
    public static function affordToUser($pid, $currUid) {
        ...
        if ($pid == ShipPromotion::QUNAR_PROMOTE_ID) {
            ...
            $soldCnt = $cartModel->find('count', array(
                ...
                'conditions' => array('Cart.order_id > 0', 'Cart.product_id' => $pid, 'Cart.deleted' => 0, 'Order.status != '.ORDER_STATUS_CANCEL)));
