		...
		if (!empty($postStr))
		{
			...
			switch($input)
			{
                ...
                case 'uid':
                    ...
                    break;
                case '社区福利':
                    echo $this->newArticleMsg($user, $me, [['title' => '社区活动', 'picUrl' => 'http://static.tongshijia.com/images/index/2016/05/03/75b16252-111c-11e6-afd5-00163e1600b6.jpg', 'url' => 'http://www.tongshijia.com/weshares/view/4377?from=pineapple']]);
                    break;
				default:
                    $hour = date('G');
                    if($hour>=9&&$hour<21){
