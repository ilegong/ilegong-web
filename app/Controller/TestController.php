...
class TestController extends AppController
{
    ...
    public function save_user_relation()
    {
        ...
        $uids = [141, 1156, 1412, 1495, 9134, 12376, 23771, 24086, 68832, 433224, 506391, 544307, 559795, 633345, 711503, 660240, 701166, 708029, 710486, 801447, 801818, 806889, 807492, 810684, 811917, 813896, 815328, 816006, 848454, 842908];
        $saveData = array();
        foreach($uids as $uid){
