...
class ShipPromotion extends AppModel {
    ...
    PRODUCT_ID_CAKE => array('limit_ship' => true,
        'items' => array(
            ...
            array('id' => 25, 'ship_price' => 0.0,  'time' => '', 'least_num' => 10,  'address' => '五环内满10个起送, 包邮'),
            array('id' => 26, 'ship_price' => 5.0, 'time' => '', 'least_num' => 20,  'address' => '五环外满20个起送, 运送费：每个5元'),
            array('id' => 28, 'ship_price' => 0.0, 'time' => '', 'address' => '昌平专场（超过20个发货)'),
            array('id' => 29, 'ship_price' => 0.0, 'time' => '', 'address' => '顺义专场（超过20个发货)'),
        )
    ),
