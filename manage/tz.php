...
body{overflow-x : hidden;  text-align: center;width:920px; margin: 0 auto; padding: 0; background-color:#fafafa;font-size:12px;font-family:Tahoma, Arial}
...
table{width:920px;clear:both;padding: 0; margin: 0 0 20px;border-collapse:collapse; border-spacing: 0;
